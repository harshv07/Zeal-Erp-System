        ...
        <div class="nav-header">
            <a href="#" class="brand-logo">
                ...
                <div class="brand-title">
                    <h2 class="">Zeal.</h2>
                    <span class="brand-sub-title">@zcoer</span>
                </div>
            </a>
            ...
            <div class="header-content">
                <nav class="navbar navbar-expand">
                  ...
                  <a class="nav-link" href="javascript:void(0);">
                    ...
                    <span
                      class="badge light text-white bg-secondary rounded-circle"
                      >76</span
                    >
                  </a>
                </li> -->
                            <!-- <li class="nav-item dropdown notification_dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="all-notification" href="{{ asset('javascript:void(0)') }}">See all notifications <i class="ti-arrow-end"></i></a>
                                </div>
                            </li>
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell-link" href="{{ asset('javascript:void(0)') }}">
                                    <svg width="28" height="28" viewbox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      ">
                                        <ul class="timeline">
                                            <li>
                                                ...
                                                <a class="timeline-panel text-muted" href="{{ asset('javascript:void(0)') }}">
        ...
        ***********************************-->
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <!-- <li><a href="index-2.html{{ asset('') }}">Dashboard Dark</a></li>
                            <li><a href="project-page.html{{ asset('') }}">Project</a></li>
                            <li><a href="contacts.html{{ asset('') }}">Contacts</a></li>
                            <li><a href="kanban.html{{ asset('') }}">Kanban</a></li>
                            <li><a href="calendar-page.html{{ asset('') }}">Calendar</a></li>
                            <li><a href="message.html{{ asset('') }}">Messages</a></li> -->
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('user.show') }}">Students</a></li>
                            <!-- <li><a href="{{ asset('post-details.html') }}">Teachers</a></li>
                            <li><a href="{{ asset('app-calender.html') }}">Admins</a></li>
                            <li><a href="{{ asset('app-calender.html') }}">Super Admins</a></li> -->
                    ...
                    <!-- <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li>
                                <a class="has-arrow" href="{{ asset('javascript:void()') }}" aria-expanded="false">Email</a>
                                <ul aria-expanded="false">
                                    <li><a href="email-compose.html{{ asset('') }}">Compose</a></li>
                                    <li><a href="email-inbox.html{{ asset('') }}">Inbox</a></li> -->
                    <!-- <li><a href="{{ asset('email-read.html') }}">Read</a></li>
                </ul>
                </li>
                <li><a href="{{ asset('app-calender.html') }}">Calendar</a></li>
                <li>
                    <a class="has-arrow" href="javascript:void(){{ asset('') }}" aria-expanded="false">Shop</a>
                    <ul aria-expanded="false"> -->
                    <!-- <li><a href="{{ asset('ecom-product-grid.html') }}">Product Grid</a></li>
                    <li><a href="ecom-product-list.html{{ asset('') }}">Product List</a></li>
                    <li>
                        <a href="ecom-product-detail.html{{ asset('') }}">Product Details</a>
                    </li>
                    <li><a href="ecom-product-order.html{{ asset('') }}">Order</a></li>
                    <li><a href="ecom-checkout.html{{ asset('') }}">Checkout</a></li>
                    <li><a href="ecom-invoice.html{{ asset('') }}">Invoice</a></li>
                    <li><a href="ecom-customers.html{{ asset('') }}">Customers</a></li>
                </ul>
                </li>
                </ul>
                </li> -->
                    <!-- <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="chart-morris.html{{ asset('') }}">Morris</a></li>
                            <li><a href="chart-chartjs.html{{ asset('') }}">Chartjs</a></li>
                            <li><a href="chart-chartist.html{{ asset('') }}">Chartist</a></li>
                            <li><a href="chart-sparkline.html{{ asset('') }}">Sparkline</a></li>
                            <li><a href="chart-peity.html{{ asset('') }}">Peity</a></li>
                        </ul>
                    </li>
                    <li> -->
                    ...
                    <!-- <li><a href="ui-carousel.html{{ asset('') }}">Carousel</a></li>
                            <li><a href="ui-dropdown.html{{ asset('') }}">Dropdown</a></li>
                            <li><a href="ui-popover.html{{ asset('') }}">Popover</a></li>
                            <li><a href="ui-progressbar.html{{ asset('') }}">Progressbar</a></li>
                            <li><a href="ui-tab.html{{ asset('') }}">Tab</a></li>
                            <li><a href="ui-typography.html{{ asset('') }}">Typography</a></li>
                            <li><a href="ui-pagination.html{{ asset('') }}">Pagination</a></li>
                            <li><a href="ui-grid.html{{ asset('') }}">Grid</a></li> -->
                    <!-- </ul>
                </li> -->
                    <!-- <li>
                    ...
                    <li>
                        <a href="{{ asset('widget-basic.html') }}" class="" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ asset('form-ckeditor.html') }}">CkEditor</a></li>
                            <li><a href="{{ asset('form-pickers.html') }}">Pickers</a></li>
                            <li><a href="{{ asset('form-validation.html') }}">Form Validate</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="{{ asset('javascript:void()') }}" aria-expanded="false">
                    ...
                    <!-- <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li>
                                <a class="has-arrow" href="#" aria-expanded="false">Error</a>
                                <ul aria-expanded="false">
                ...
                <div class="copyright">
                    <p><strong>ZCOER</strong> © {{ now()->year }} All Rights Reserved</p>
                </div>
            </div>
        </div>
        <!--**********************************
