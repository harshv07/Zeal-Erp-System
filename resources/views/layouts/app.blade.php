                      ...
                      ">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    <img src="{{ auth()->user()->getFirstMediaUrl('profile_picture') }}" width="56" alt="" />
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="{{ route('show.pofile') }}" class="dropdown-item ai-icon">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('post.show')}}">Feed</a> </li>
                            <li><a href="{{route('razorpayment.pay')}}">Payment</a> </li>


                            <li><a href="{{route('chat.index')}}">Chat <span class="badge light text-white bg-success rounded-circle">{{ $cnt }}</span></a></li>

                            <li><a href="{{ url(env('APP_URL') . '/file-manager/fm-button') }}">File-manager</a></li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            @can('show_Student')
                            <li><a href="{{ route('user.showstudents') }}">Students</a></li>
                            @endcan

                            @can('show_Teacher')
                            <li><a href="{{ route('user.showteachers') }}">Teachers</a></li>
                            @endcan

                            @can('show_Admin')
                            <li><a href="{{ route('user.showadmins') }}">Admins</a></li>
                            @endcan

                            @can('show_Superadmin')
                            <li><a href="{{ route('user.showsuperadmins') }}">Super Admins</a></li>
                            @endcan
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('settings.show')}}">All Setting</a></li>
                            <!-- <li><a href="index-2.html{{ asset('') }}">Dashboard Dark</a></li>
                            <li><a href="project-page.html{{ asset('') }}">Project</a></li>
                            <li><a href="contacts.html{{ asset('') }}">Contacts</a></li>
                            <li><a href="kanban.html{{ asset('') }}">Kanban</a></li>
