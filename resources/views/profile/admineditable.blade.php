              ...
              <div class="e-profile">
                <div class="row">
                  ...
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="{{ $user->getFirstMediaUrl('profile_picture') }}" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
                      <h4>{{ $user->first_name}} {{ $user->last_name }}</h4>
                      @if($user->hasRole('Student'))
                      <p class="text-secondary mb-1">Student</p>
                      @else
                      <p class="text-secondary mb-1">{{ $user->designation->name }}</p>
                      @endif
                      <p class="text-muted font-size-sm">{{ $user->branch->name }}</p>
                      <form action="{{ route('user.admin.update',encrypt($user->id)) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="mt-2">
                            ...
                            <div class="form-group">
                              <div class="input-group input-success-o">
                                ...
                                <select name="year_id" class="form-control @error('year_id') is-invalid @enderror">
                                  ...
                                  <option value="{{ $year->id }}" {{ ($year->id == $user->year->id ? "selected" : "") }}>
                                    {{ $year->value }}
                                  </option>
                                  @endforeach
                                </select>
                            ...
                            <div class="form-group">
                              <div class="input-group input-success-o">
                                ...
                                <select name="designation_id" class="form-control @error('designation_id') is-invalid @enderror">
                                  ...
                                  <option value="{{ $designation->id }}" {{ ($designation->id == $user->designation->id ? "selected" : "") }}>
                                    {{ $designation->name }}
                                  </option>
                                  @endforeach
                                </select>
                            ...
                            <div class="form-group">
                              <div class="input-group input-danger-o">
                                ...
                                <select name="branch_id" class="form-control @error('branch_id') is-invalid @enderror">
                                  ...
                                  <option value="{{ $branch->id }}" {{ ($branch->id == $user->branch->id ? "selected" : "") }}>
                                    {{ $branch->name }}
                                  </option>
                                  @endforeach
                                </select>
